...
public class ViewCategories extends Activity implements View.OnLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Iterator<Category> i = values.iterator();
	...
	public boolean onLongClick(View view) {
		...
		(new ViewCategoryDialog((Context)this, view)).show();
		return false;
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.view_categories_menu, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
		    case R.id.add_category : {
		    	(new NewCategoryDialog(this, this)).show();
		        return true;
		    }
		    default : {
